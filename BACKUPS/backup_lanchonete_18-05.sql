...
-- Copiando dados para a tabela lanchonete3si_2023.produto: ~6 rows (aproximadamente)
INSERT INTO `produto` (`codProduto`, `nome`, `precoCusto`, `precoVenda`, `margemLucro`, `dataValidade`, `quantidadeEstoque`, `quantidadeMinima`, `CATEGORIA_codCategoria`, `MARCA_codMarca`) VALUES
	...
	(8, 'Suco de laranja', 1.80, 4.00, NULL, NULL, NULL, NULL, 2, 6),
	(9, 'Suco de Acerola', 2.00, 5.00, NULL, NULL, NULL, NULL, 4, 6);
