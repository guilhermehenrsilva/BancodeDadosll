...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela panificadoracentral.auditoria: ~68 rows (aproximadamente)
...
-- Copiando dados para a tabela panificadoracentral.categoria: ~7 rows (aproximadamente)
