...
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela panificadoracentral.auditoria: ~66 rows (aproximadamente)
...
-- Copiando dados para a tabela panificadoracentral.produtos: ~3 rows (aproximadamente)
INSERT INTO `produtos` (`codProduto`, `nomeProduto`, `precoVenda`, `margemLucro`, `dataValidade`, `marcaProduto`, `qtdEstoque`, `FORNECEDORES_cnpj`, `CATEGORIA_codCategoria`) VALUES
	(3, 'GUARANA', 2, NULL, '2023-06-09', 'ANTARTICA', NULL, '23000000', 3),
	(4, 'COCA COLA', 3, NULL, '2023-06-25', 'COLA-COLA', NULL, '01564520000185', 3),
