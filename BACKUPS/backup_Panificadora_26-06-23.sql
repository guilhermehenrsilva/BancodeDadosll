...
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela panificadoracentral.auditoria: ~24 rows (aproximadamente)
INSERT INTO `auditoria` (`codAuditoria`, `acao`, `tabela`, `dataHora`, `usuario`) VALUES
	(99, 'Cliente inserido com o CPF: 123 e com o  Nome: teste e sua data de nascimento 2023-06-24', 'clientes', '2023-06-24 10:08:14', 'root@localhost'),
	(100, 'codigo cliente1Exclusão do Cliente: teste do CPF 123', 'clientes', '2023-06-24 10:12:12', 'root@localhost'),
	(101, 'Cliente inserido com o CPF: 132 e com o  Nome: teste e sua data de nascimento 2023-06-24', 'clientes', '2023-06-24 10:13:59', 'root@localhost'),
	(102, 'codigo 2 Do Cliente: teste do CPF 132 Excluido', 'clientes', '2023-06-24 10:14:15', 'root@localhost'),
	(103, 'Cliente inserido com o CPF: 132 e com o  Nome: tetse e sua data de nascimento 2023-06-24', 'clientes', '2023-06-24 10:16:24', 'root@localhost'),
	(104, 'codigo 3 Do Cliente: tetse do CPF 132 Excluido', 'clientes', '2023-06-24 10:19:20', 'root@localhost'),
	(105, 'Cliente inserido com o CPF: 132 e com o  Nome: guilherme e sua data de nascimento 0000-00-00', 'clientes', '2023-06-24 10:24:44', 'root@localhost'),
	(106, NULL, 'produtos', '2023-06-24 10:28:52', 'root@localhost'),
	(107, NULL, 'clientes', '2023-06-24 10:55:36', 'root@localhost'),
	(108, NULL, 'clientes', '2023-06-24 10:55:43', 'root@localhost'),
	(109, NULL, 'clientes', '2023-06-24 11:15:30', 'root@localhost'),
	(110, 'codigo 4 Do Cliente: guilherme do CPF 132 Excluido', 'clientes', '2023-06-24 12:01:10', 'root@localhost'),
	(111, 'Cliente inserido com o CPF: 132 e com o  Nome: guilherme e sua data de nascimento 1997-12-27', 'clientes', '2023-06-24 12:02:16', 'root@localhost'),
	(112, 'Email do cliente: guilherme foi alterado para guilherme@gmail.com', 'clientes', '2023-06-24 12:29:59', 'root@localhost'),
	(113, NULL, 'clientes', '2023-06-24 13:21:18', 'root@localhost'),
	(114, NULL, 'clientes', '2023-06-24 15:19:33', 'root@localhost'),
	(115, NULL, 'clientes', '2023-06-24 15:21:32', 'root@localhost'),
	(116, 'Email do cliente: guilherme foi alterado para guilherme;.com', 'clientes', '2023-06-24 21:48:51', 'root@localhost'),
	(117, 'Email do cliente: teste foi alterado para g.com', 'clientes', '2023-06-24 21:48:55', 'root@localhost'),
	(118, 'Email do cliente: Teste foi alterado para Teste.com', 'clientes', '2023-06-24 21:48:59', 'root@localhost'),
	(119, NULL, 'clientes', '2023-06-25 19:46:08', 'root@localhost'),
	(120, 'codigo 14 Do Cliente: guilherme do CPF 5566 Excluido', 'clientes', '2023-06-25 19:46:29', 'root@localhost'),
	(121, 'Cliente inserido com o CPF: 44444 e com o  Nome: teste e sua data de nascimento 2023-06-25', 'clientes', '2023-06-25 19:47:04', 'root@localhost'),
	(122, 'Email do cliente: teste foi alterado para test.com', 'clientes', '2023-06-25 19:51:20', 'root@localhost');
...
-- Copiando dados para a tabela panificadoracentral.clientes: ~5 rows (aproximadamente)
INSERT INTO `clientes` (`codCliente`, `cpf`, `nomeCliente`, `dataNascimento`, `telefone`, `email`, `cidadeCliente`, `enderecoCliente`, `bairro`, `cep`, `uf`) VALUES
	(5, '132', 'teste', '2023-05-27', '35333', 'test.com', '', '', '', '', ''),
	(6, '145', 'Teste', '2023-06-26', '3522', 'Teste.com', NULL, NULL, NULL, NULL, NULL),
	(11, '455', 'teste', '2023-06-25', '35', 'g.com', NULL, NULL, NULL, NULL, NULL),
	(12, '556', 'guilherme', '2023-06-24', '359666', 'guilherme;.com', NULL, NULL, NULL, NULL, NULL),
	(15, '44444', 'teste', '2023-06-25', '55556', 'j.com', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `produtos` (`codProduto`, `nomeProduto`, `precoVenda`, `margemLucro`, `dataValidade`, `marcaProduto`, `qtdEstoque`, `FORNECEDORES_cnpj`, `CATEGORIA_codCategoria`) VALUES
	(22, 'BOLACHA', 0, NULL, NULL, '', NULL, '132', 15);
...
CREATE PROCEDURE `new_deleteCliente`(
	IN `codClienteDel` varchar(20)
)
BEGIN
	SELECT COUNT(*) INTO @contador  FROM clientes 
	WHERE clientes.codCliente = codClienteDel;
if(@contador = 0)	
	then SELECT "Cliente não encontrado!!!!" AS erro;
	else
	delete from clientes where clientes.codCliente = codClienteDel;
END if;
END//
DELIMITER ;
...
DELIMITER //
CREATE PROCEDURE `new_deleteVenda`(
	IN `codExcluirVenda` int
)
BEGIN
DELETE FROM vendas_geral
WHERE codVendaG = codExcluirVenda;
...
-- Copiando estrutura para procedure panificadoracentral.new_VendasClienteProdutos
DROP PROCEDURE IF EXISTS `new_VendasClienteProdutos`;
DELIMITER //
CREATE PROCEDURE `new_VendasClienteProdutos`()
BEGIN
SELECT codVendaG AS "Código da venda",
 	nomeProduto AS "Descrição do produto",
 	tipovenda AS "Tipo de Vendas", 
 	CLIENTES_cpf AS "Cpf do cliente",
 	nomeCliente AS "Nome do Cliente"
 FROM vendas_geral
 INNER JOIN produtos_venda AS pv
 INNER JOIN produtos AS prod
 INNER JOIN clientes
 	WHERE VENDAS_GERAL_codVendaG = codVendaG
 	AND CLIENTES_cpf  = cpf 
 	AND PRODUTOS_codProduto = codProduto;
...
-- Copiando estrutura para trigger panificadoracentral.tri_DeleteVenda
DROP TRIGGER IF EXISTS `tri_DeleteVenda`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tri_DeleteVenda` BEFORE DELETE ON `vendas_geral` FOR EACH ROW BEGIN

DELETE FROM produtos_venda 
WHERE produtos_venda.VENDAS_GERAL_codVendaG = OLD.codVendaG;
...
CREATE TRIGGER `tri_LogDeleteCli` AFTER DELETE ON `clientes` FOR EACH ROW BEGIN 
	...
	SET @mensagem = CONCAT("codigo ", OLD.codCliente,  " Do Cliente: ", OLD.nomeCliente, " do CPF ", OLD.cpf," Excluido");
