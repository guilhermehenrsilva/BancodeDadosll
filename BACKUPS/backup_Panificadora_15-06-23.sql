...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela panificadoracentral.auditoria: ~76 rows (aproximadamente)
INSERT INTO `auditoria` (`codAuditoria`, `acao`, `tabela`, `dataHora`, `usuario`) VALUES
	...
	(71, 'Email do cliente: teste foi alterado para teste', 'clientes', '2023-05-29 21:04:18', 'root@localhost'),
	(72, 'Produto vendido = FANTA Quantidade = 0.00 para a venda = 16', 'itemvenda', '2023-06-15 02:51:28', 'root@localhost'),
	(73, 'Produto vendido = FANTA Quantidade = 50.00 para a venda = 17', 'itemvenda', '2023-06-15 02:52:19', 'root@localhost'),
	(76, 'Produto vendido = FANTA Quantidade = 10.00 para a venda = 12', 'itemvenda', '2023-06-15 16:53:59', 'root@localhost'),
	(77, 'Produto inserido: 11TESTE com a data de validade 2024-06-15 e Marca: TESTE', 'produtos', '2023-06-15 17:18:52', 'root@localhost'),
	(78, 'Produto vendido = TESTE Quantidade = 10.00 para a venda = 18', 'itemvenda', '2023-06-15 17:19:13', 'root@localhost');
...
-- Copiando dados para a tabela panificadoracentral.categoria: ~6 rows (aproximadamente)
...
INSERT INTO `clientes` (`cpf`, `nomeCliente`, `dataNascimento`, `telefone`, `email`, `cidadeCliente`, `enderecoCliente`, `bairro`, `cep`, `uf`) VALUES
	...
	('1222', 'teste', '1997-05-23', '352222', 'teste', 'teste', 'teste', 'teste', '37750000', 'mg'),
...
-- Copiando dados para a tabela panificadoracentral.produtos: ~2 rows (aproximadamente)
INSERT INTO `produtos` (`codProduto`, `nomeProduto`, `precoVenda`, `margemLucro`, `dataValidade`, `marcaProduto`, `qtdEstoque`, `FORNECEDORES_cnpj`, `CATEGORIA_codCategoria`) VALUES
	(8, 'FANTA', 3, NULL, '2023-06-11', 'COCA-COLA', 40.00, '23000000', 3),
	(11, 'TESTE', 3, NULL, '2024-06-15', 'TESTE', 40.00, '01564520000185', 3);
...
-- Copiando dados para a tabela panificadoracentral.vendas_geral: ~5 rows (aproximadamente)
INSERT INTO `vendas_geral` (`codVendaG`, `datahoraVenda`, `tipoVenda`, `nomeVendedor`, `CLIENTES_cpf`) VALUES
	...
	(16, '2023-06-14 23:50:40', 'À Vista', 'Otavio', '12983639690'),
	(18, '2023-06-15 17:17:51', 'À Vista', 'Otavio', '12983639690');
