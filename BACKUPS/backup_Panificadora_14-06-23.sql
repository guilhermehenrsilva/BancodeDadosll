...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela panificadoracentral.auditoria: ~73 rows (aproximadamente)
...
INSERT INTO `produtos` (`codProduto`, `nomeProduto`, `precoVenda`, `margemLucro`, `dataValidade`, `marcaProduto`, `qtdEstoque`, `FORNECEDORES_cnpj`, `CATEGORIA_codCategoria`) VALUES
	(8, 'FANTA', 3, NULL, '2023-06-11', 'COCA-COLA', 50.00, '23000000', 3);
...
-- Copiando dados para a tabela panificadoracentral.produtos_venda: ~3 rows (aproximadamente)
...
INSERT INTO `vendas_geral` (`codVendaG`, `datahoraVenda`, `tipoVenda`, `nomeVendedor`, `CLIENTES_cpf`) VALUES
	...
	(17, '2023-06-14 23:51:50', 'À Vista', 'otavio', '12983639690');
