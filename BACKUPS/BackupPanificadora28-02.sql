...
-- Copiando dados para a tabela panificadoracentral.fornecedores: ~2 rows (aproximadamente)
INSERT INTO `fornecedores` (`cnpj`, `nomeFornecedor`, `telefoneFornecedor`, `email`, `enderecoFornecedor`, `bairro`, `cidadeFornecedor`, `cep`, `uf`) VALUES
	...
	('03456520000158', 'Açai Brasil', '4752-1786', 'acai@gmail.com', 'rua dos açai', 'Centro', 'São Paulo', '47850000', 'SP'),
...
-- Copiando dados para a tabela panificadoracentral.vendas_geral: ~1 rows (aproximadamente)
INSERT INTO `vendas_geral` (`codVendaG`, `datahoraVenda`, `tipoVenda`, `nomeVendedor`, `CLIENTES_cpf`) VALUES
	(1, '2022-11-16 08:41:00', 'À Vista', 'Suzana', '12983639690');
